...
export default function Team() {
    ...
    const team = [
        ...
        { name: 'Louis Laureys', role: 'Student CMGT', description: 'Ik hou er van om technisch ingewikkelde problemen aan te pakken, en dan ook op een goede manier. Van frontend tot backend tot linux, allemaal leuk. M\'n huis is een enorme jungle, en ik hou stiekem wel van koken.'},
