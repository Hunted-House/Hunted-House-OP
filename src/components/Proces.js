...
export default function Proces() {
  ...
  return (
    <section id='progress' className='bg-quaternary min-h-screen w-full'>
      ...
      <div className="py-16 px-4 mx-auto max-w-screen-xl lg:py-24 lg:px-6 lg:pt-96 z-10 relative">
        <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 lg:pt-24">
          <h2 className="title text-black">Het proces</h2>
        </div>
